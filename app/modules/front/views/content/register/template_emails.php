               ...
               <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                 <tr style="border-collapse:collapse;">
                  <td width="560" valign="top" align="center" style="padding:0;Margin:0;">
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                     <tr style="border-collapse:collapse;">
                      <td align="center" style="padding:0;Margin:0;"><h1 style="Margin:0;line-height:31px;font-size:26px;color:#ffb500!important;"><strong>IDEA PAPER</strong></h1></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                     ...
                     <tr style="border-collapse:collapse;">
                      <td  style="padding:0;Margin:0;padding-right:5px;padding-left:5px;">
                        ...
                        <p style="text-align:left;Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:12px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;">
                          Hi, <b><?=strtoupper($nama)?></b> Terimakasih telah bergabung di IDEA PAPER, berikut adalah data diri anda :
                        </p>
                          ...
                          <table style="color: #666666;margin-top:10px;font-size:12px;">
                            ...
                            <tr>
                              <td>Email</td>
                              <td>: <a style="font-size:12px!important" ><?=$email?></a></td>
                            </tr>
                     ...
                     <tr style="border-collapse:collapse;">
                      <td align="center" style="padding-top:15px;Margin:0;">
                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;color:#ffb500;">
                          ...
                          <br>
                           085288882994&nbsp;
                          <a style="color:#ffb500" target="_blank" href="mailto:info@mpampam.com" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-size:14px;text-decoration:none;color:#666666;">ideapaper@ideadigitalindonesia.com</a>
                          <br>
                          <a style="color:#ffb500;text-decoration:none;font-weight:bold" target="_blank" href="<?=site_url()?>">www.ideapaper.com</a>
                        </p>
                      </td>
                     </tr>
                   </table></td>
