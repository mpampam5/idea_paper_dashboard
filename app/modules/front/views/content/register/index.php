            ...
            <div class="auth-form-light text-left px-4 px-sm-5">
              ...
              <form class="pt-3">
                <div class="form-group">
                  <input type="text" class="form-control form-control-sm" id="nik" placeholder="NIK (No. Identitas Kependudukan)">
                </div>
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-sm" id="" placeholder="Telepon">
                </div>
